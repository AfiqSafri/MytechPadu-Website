...
export default function Services() {
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-night text-white px-2 sm:px-4 pb-24">
      <div className="relative w-full flex flex-col items-center justify-center py-10 sm:py-16 mb-6 sm:mb-8 bg-black/60 border-b border-white/10 shadow-lg">
        <h1 className="text-3xl sm:text-5xl font-extrabold mb-2 text-center tracking-tight">Our Services</h1>
      ...
      <div className="relative flex flex-col md:flex-row gap-6 sm:gap-8 w-full max-w-xs sm:max-w-4xl justify-center">
        <ServiceCard
