...
export default function Contact() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center bg-night text-white px-2 sm:px-4 pb-24 overflow-hidden">
      ...
      <form onSubmit={handleSubmit} className="relative z-10 w-full max-w-xs sm:max-w-md bg-black/80 rounded-lg p-4 sm:p-8 border border-white flex flex-col gap-4 mb-6 sm:mb-8">
